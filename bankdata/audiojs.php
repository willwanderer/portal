    ...
    <div class="mb-container">
        <div class="mb-middle">
            ...
            <div class="mb-content">
                <p>Anda yakin ingin keluar aplikasi?</p>                    
                <p>Pilih "Ya" untuk Keluar Aplikasi. Pilih "Tidak" untuk membatalkan.</p>
            </div>
            <div class="mb-footer">
                <div class="pull-right">
                    <a href="../logout.php" class="btn btn-success btn-lg">Ya</a>
