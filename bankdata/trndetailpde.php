                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9" id="divriwayatpemeriksaan">
                            ...
                            <div id="detprofilentitas">
                                <div class="panel panel-success">
                                    <div class="panel-body">
                                        ...
                                        <textarea class="summernote" id="txtgambaranumum" name="txtgambaranumum"></textarea>
                                        <br>
                                        <h2><small>Geografis</small></h2>
                                        <textarea class="summernote" id="txtgeografis" name="txtgeografis"></textarea>
                                        <br>
                                        <h2><small>Batas Wilayah</small></h2>
                                        <textarea class="summernote" id="txtbataswilayah" name="txtbataswilayah"></textarea>
                            ...
                            <div id="detdaftarskpdkecamatan">
                                <div class="panel panel-success">
                                    <div class="panel-body">                           
                                        <textarea class="summernote" id="txtskpdkecamatan" name="txtskpdkecamatan"></textarea>
                                        <br>
                                        <h2><small>Daftar SKPD dan Kecamatan</small></h2>
                                                    ...
                                                    if(isset($datatimdosir))
                                                    {
                                                        foreach ($datatimdosir as $keytimdosir => $valuetimdosir)
                                                        {
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $valuetimdosir["DOS_STATUS"] ?></td>
                                                                <td>
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <?php
                                                                            ...
                                                                            {
                                                                                ?>
                                                                                    <button class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" title="Nonaktifkan Pegawai pada Tim Dosir" onclick="ubahstatuspenanggungjawab('<?php echo $valuetimdosir["DOS_ID"]; ?>','Tidak Aktif')"><i class="fa fa-ban"></i></button>
                                                                                <?php 
                                                                            }
                                                                            else
                                                                            {
                                                                                ?>
                                                                                    <button class="btn btn-default btn-xs" data-toggle="tooltip" data-placement="top" title="Aktifkan Pegawai pada Tim Dosir" onclick="ubahstatuspenanggungjawab('<?php echo $valuetimdosir["DOS_ID"]; ?>','Aktif')"><i class="fa fa-check"></i></button>
                                                                                <?php 
                                                                            }
                                                                        ?>                                 
                                                                    </div>
