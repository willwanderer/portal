...
<head>
    ...
    <style>
        ...
        * {
        ...
        .surprise { background-color: #b3e5fc; color: #007bb5; }
        .summarize { background-color: #ffecb3; color: #f57c00; }
        .advice { background-color: #c8e6c9; color: #388e3c; }
        .write { background-color: #f8bbd0; color: #c2185b; }
        .code { background-color: #e1bee7; color: #8e24aa; }
        .more { background-color: #d7ccc8; color: #6d4c41; }
